...
<div class="detail-right">
	<?php echo $commiter['TsUser']['username'];?>
	<br /><br /><br />
	<?php echo $commiter['TsUser']['sex'];?>
	<br /><br /><br />
	
	<span class="detail-in">facebook:</span>
	<a href="http://facebook.com/<?php echo $commiter['TsUser']['facebook_id'];?>">
		<img src="https://graph.facebook.com/<?php echo $commiter['TsUser']['facebook_id'];?>/picture" />
	</a>
	<br /><br />
	
	<span class="detail-in">twitter:</span>
	<a href="http://twitter.com/<?php echo $commiter['TsUser']['twitter_id'];?>">
		<img src="http://api.twitter.com/1/users/profile_image?screen_name=<?php echo $commiter['TsUser']['twitter_id'];?>&size=normal" />
	</a>
</div>
...
<?php	
	...
	echo '<a href="userprof?id='. $commiter['TsUser']['id'] . '">
			<img src="https://graph.facebook.com/'. $commiter['TsUser']['facebook_id'] .'/picture" width="30px" />
		</a>';
	echo "ホスト";
	echo "<br />";
	//予定に参加するゲストユーザ
